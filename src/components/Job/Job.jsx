        ...
        <div className="card-body">
          ...
          <div className='flex gap-5 font-semibold py-2 text-gray-500'>
            <div className='flex gap-2 items-center'>
                <h3><GrLocation className='text-lg'></GrLocation></h3>
                <p>{location}</p>
            </div>
            <div className='flex gap-2 items-center'>
                <h3><HiOutlineCurrencyDollar className='text-lg'></HiOutlineCurrencyDollar></h3>
                <p>Salary : {salary}</p>
            </div>
          </div>
          <div className="card-actions">
            <button className="btn hover:bg-purple-800 bg-purple-500 text-white">
              View Details
            </button>
          </div>
        </div>
